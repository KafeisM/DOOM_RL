...
def main():
    ...
    model = PPO.load("../train/train_deadly_corridor_curriculum/best_model_stage4.zip")

    # Crear el mismo entorno que se usó para entrenar, pero con render=True
    env = VizDoomGymReward(render=True, config="./Scenarios/deadly_corridor/deadly_corridor - t1.cfg")
